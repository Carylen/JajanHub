...
export interface AuthContextValue {
  isLoggedIn: boolean;
  /** True until the initial `useSession()` fetch resolves — guards must wait on this before deciding to gate, or an already-logged-in visitor would see a false-positive login prompt flash on every hard reload. */
